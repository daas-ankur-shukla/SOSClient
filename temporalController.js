        ...
        if (!!_options.markers[ui.value]) {
          ...
          if (_options.markers[ui.value].feature !== undefined) {
            if (_options.markers[ui.value].feature.properties.startDate) {
              if (_options.markers[ui.value])
                $('#slider-timestamp').html(_options.markers[ui.value].feature.properties.startDate);
              }
            else {
            ...
            if (_options.markers[ui.value].options.time) {
              if (_options.markers[ui.value])
                $('#slider-timestamp').html(_options.markers[ui.value].options.startDate.substr(0, 19));
              }
            else {
              console.error("You have to have a time property")
            }
